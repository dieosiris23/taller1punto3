...
class BusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus" do
    assert_difference('Bus.count') do
      post buses_url, params: { bus: { brand: @bus.brand, capacity: @bus.capacity, licenseplate: @bus.licenseplate, startdate: @bus.startdate } }, as: :json
    end
  ...
  test "should update bus" do
    patch bus_url(@bus), params: { bus: { brand: @bus.brand, capacity: @bus.capacity, licenseplate: @bus.licenseplate, startdate: @bus.startdate } }, as: :json
    assert_response 200
  end
